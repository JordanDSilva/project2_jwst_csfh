...
match_egs = coordmatch(
  ...
  coordcompare = load_with_agn[, c("RA", "DEC")],
  rad = 1.0
)

match_egs_cat = ceers_egs_cat[match_egs$bestmatch$refID, ]
match_galaxies_withAGN = load_with_agn[match_egs$bestmatch$compareID, ]
match_galaxies_withoutAGN = load_without_agn[match_egs$bestmatch$compareID, ]
